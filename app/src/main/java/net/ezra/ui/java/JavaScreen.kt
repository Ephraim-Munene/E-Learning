...
@Composable
fun JavaScreen(navController: NavHostController) {
    ...
    Column {
        Row {
            ...
            Text(text = "Java Courses", fontSize = 30.sp)
        ...
        Box {
            ...
            Column(
                ...
                PythonLessonCard(
                    lessonTitle = "Lesson 1: Introduction to Java",
...
fun HomeScreenPreviewLight() {
    JavaScreen(rememberNavController())
}
